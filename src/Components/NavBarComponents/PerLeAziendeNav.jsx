...
import { Grid3x3GapFill, PlusLg, XLg } from "react-bootstrap-icons";

const PerLeAziendeNav = () => {
  return (
    <div className="d-flex align-items-center justify-content-center flex-column">
      ...
      <Nav className="p-0">
        ...
        >
          ...
          <h6 className="text-dark mx-1">Scopri altri prodotti Linkedin</h6>

          <NavDropdown.Item>
            <div className="fs-2 text-primary text-start ms-2 mt-3 ">
              <svg
            ...
            <div className="colors">
              <h6 className="mt-4">Scopri altro per il business</h6>
            ...
            <div className="colors">
              ...
              <span className="text-secondary">Trova candidati di qualità</span>
            </div>
            <div className="colors">
