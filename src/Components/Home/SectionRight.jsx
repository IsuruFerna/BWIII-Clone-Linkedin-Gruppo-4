    ...
    <>
      <Card className="mb-5 rounded-3 shadow">
        <Card.Title className="d-flex justify-content-between align-items-center me-3 fw-semibold fs-6 mt-2 ms-2">
          ...
          <InfoSquareFill className=" pointer" />
        </Card.Title>
        <Card.Text className="mt-2 fw-semibold text-dark mb-1 smaller ms-1  pointer">
        ...
        <Card.Text className="fw-semibold text-dark mb-1 smaller ms-1 pointer">
