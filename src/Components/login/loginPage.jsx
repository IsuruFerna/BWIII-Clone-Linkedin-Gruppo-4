...
<Form>
      <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
        ...
        <Form.Control className='formInput' type="email number" />
      </Form.Group>
      ...
      <Row className='mt-5'><Button variant="primary" className='rounded-pill pt-2 pb-2 fw-bold bg-primary'>Accedi</Button></Row>
   ...
   <Row><Button className='col-6 my-3 rounded-pill border-secondary text-secondary'><img className='logoGoogle' src='https://tse4.mm.bing.net/th?id=OIP.CgKRXkxzJnLtDG-qapK4owHaHa&pid=Api&P=0&h=180'></img>Continue with Google</Button></Row>
