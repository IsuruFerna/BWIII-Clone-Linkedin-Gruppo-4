...
const ModifySingleExperience = () => {
   ...
   const reduxModelModifyExp = useSelector(
      (state) => state.user.modelModifyExp
   );
   const [formEditData, setEditFormData] = useState(null);
   console.log("getting stored data in experience page", reduxModelModifyExp);
   //    fetch(
   ...
   console.log("sendig data: ", formEditData);

   console.log("modified redux model", reduxModelModifyExp);
   ...
   return (
      <>
         ...
         {reduxModelModifyExp && <EditExperience formEditData={formEditData} />}
      </>
   );
};
