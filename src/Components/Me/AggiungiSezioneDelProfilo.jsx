         ...
         >
            <Accordion>
               ...
               <Accordion.Item eventKey="0">
                  ...
                  <Accordion.Body>
                     <p className="mb-2">
                        Iniziamo dalle basi. Se compili queste sezioni, sarà più
                        facile trovarti per i recruiter e le persone che
                        potresti conoscere.
                     </p>
                     <ListGroup>
               ...
               <Accordion.Item eventKey="1">
                  ...
                  <Accordion.Body>
                     <p className="mb-2">
                        Completando queste sezioni aumenterai la tua credibilità
                        e potrai accedere a più opportunità.
                     </p>
                     <ListGroup>
                        <ListGroupItem className="border border-0 ps-0 ">
                           <p className="text-secondary mb-1 pointer">
               ...
               <Accordion.Item eventKey="2">
                  ...
                  <Accordion.Body>
                     <p className="mb-2">
                        ...
                        sezioni ti aiuteranno a espandere la tua rete e a
                        instaurare più relazioni lavorative.
                     </p>
                     <ListGroup>
                        <ListGroupItem className="border border-0 ps-0 ">
                           <p className="text-secondary mb-1 pointer">
