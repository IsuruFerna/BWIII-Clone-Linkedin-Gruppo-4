    ...
    <>
      ...
      >
        <Offcanvas.Header closeButton>
          <Offcanvas.Title className="px-2 mt-1">
            Per le aziende
          </Offcanvas.Title>
        </Offcanvas.Header>
        <Offcanvas.Body className="px-4 rounded-4 ">
                ...
                <Card.Text className="py-3">
                  <div className="w-100 d-flex justify-content-around align-items-start">
                    <Link className="d-flex flex-column align-items-center justify-content-center link-underline link-underline-opacity-0">
                      <div className="border rounded d-flex align-items-center justify-content-center pb-2 border border-white-subtle">
                        <svg
                      ...
                      <p className="text-secondary lh-1 text-center mt-1 fs-7 ms-1">
                        Learning
                      </p>
                    </Link>
                    <Link className="d-flex flex-column align-items-center justify-content-center link-underline link-underline-opacity-0">
                    ...
                    <Link className="d-flex flex-column align-items-center justify-content-center link-underline link-underline-opacity-0">
                      ...
                      <p className="text-secondary lh-1 text-center mt-1 fs-7 me-2">
                        Pubblicizza
                      </p>
                    </Link>
                  </div>
                  <div className="w-75  d-flex justify-content-around align-items-start">
                    <Link className="d-flex flex-column align-items-center justify-content-center link-underline link-underline-opacity-0">
                      <div className="border rounded px-2 pb-1 d-flex align-items-center justify-content-center">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 40 40"
                          data-supported-dps="40x40"
                    ...
                    <Link className="d-flex flex-column align-items-center justify-content-center link-underline link-underline-opacity-0">
                      <div className="border rounded px-2 pb-1 ps-1 d-flex align-items-center justify-content-center">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 35 35"
                          data-supported-dps="40x40"
                    ...
                    <Link className="d-flex flex-column align-items-center justify-content-center link-underline link-underline-opacity-0">
                      <div className="border rounded p-1 pe-3 d-flex align-items-center justify-content-center">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="2 1 37 36"
                          data-supported-dps="40x40"
          ...
          <Card className="mt-2 border border-white-subtle">
            <Card.Header className="bg-white fw-semibold py-3 px-3 border border-white-subtle">
              Scopri altro per business
            </Card.Header>
            <Card.Body>
