      ...
      <Navbar expand="lg" className="bg-body-tertiary">
         <Container>
            ...
            <div className="text-secondary d-flex flex-column ms-3">
               <PeopleFill className="fs-5 ms-1" />{" "}
               <h6 className="me-4">Rete</h6>
            </div>
            <div className="text-secondary d-flex flex-column">
            ...
            <div className="text-secondary d-flex flex-column">
               <BellFill className="fs-5 ms-4" />{" "}
               <h6 className="me-4">Notifiche</h6>
            </div>

            <div className="d-flex flex-column justify-content-center align-items-center position-relative">
               <Grid3x3GapFill className="text-secondary me-4 position-absolute top-0 start-50 translate-middle-x" />
